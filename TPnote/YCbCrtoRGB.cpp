...
int main(int argc, char **argv)
{
    ...
    char *imgR = (char *)malloc(strlen(cNomImgEcrite) + 20);
    char *imG = (char *)malloc(strlen(cNomImgEcrite) + 20);
    char *imgB = (char *)malloc(strlen(cNomImgEcrite) + 20);
    ...
    char *imgA = (char *)malloc(strlen(cNomImgEcrite) + 20);
